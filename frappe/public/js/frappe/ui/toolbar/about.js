...
frappe.ui.misc.about = function () {
	...
	const dialog = new frappe.ui.Dialog({ title: __("About Tech") });

	$(dialog.body).html(
		`<div>
				<p>${__("Modern Business Applications for the Web")}</p>
				...
				<p class='text-muted'>${__("&copy; Tech and contributors")} </p>
			</div>`
	);
